package com.company;
 ...
 class DieselFuelDispenser implements FuelDispenser {
     private String type;
     private double Unit_price;
     private double Amount;

     public DieselFuelDispenser(String type, double Unit_price,double Amount){
         this.type=type;
     ...
     public void Checksfuelleft() {
         //Checks if there is fuel and print remaining stock
     ...
     public void the_total_income_of_theGasStation_per_day_per_fuel_type() {
         //prints the Total income of the gasstation per day and per fuel type
